        ...
        <section className="bg-slate-900 text-white">
          <div className="container flex flex-col-reverse md:flex-row items-center py-16 md:py-24">
            ...
            <div className="md:w-1/2 flex justify-center mb-8 md:mb-0">
              <Image
                src="/web developer.jpg.svg? height=400&width=400"
                width={400}
                height={400}
                alt="Hero"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-50 rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <p className="mb-4">3+ years of experience in web development with expertise in React, Next.js, and modern JavaScript frameworks.</p>
                  <div className="flex space-x-3">
                    ...
                    <a href="https://linkedin.com/in/drb30" className="text-blue-700 hover:text-blue-900">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
                      </svg>
                    </a>
                    <a href="https://github.com/dols30" className="text-gray-800 hover:text-gray-600">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-slate-600">
                  "The courses at WebtiCode transformed my career. I went from knowing basic HTML to building complex React applications in just a few months. The instructors are fantastic and really care about your success."
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-slate-600">
                  "As someone transitioning from graphic design to UX/UI, the design courses at WebtiCode gave me exactly what I needed. The practical projects and instructor feedback helped me build a portfolio that landed me my dream job."
                </p>
                <div className="flex mt-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-yellow-400">
                    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
